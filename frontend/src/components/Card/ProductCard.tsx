...
const ProductCard: React.FC<ProductCardProps> = ({ id, image, name, price, size }) => {
    ...
    return (
        <div
            className={`rounded-xl p-4 bg-[#151515] text-white font-robotoCondensed shadow-md hover:cursor-pointer hover:border hover:border-neutral-800 flex flex-col justify-between`}
        >
